        ...
        <div class="inner-header">
            ...
            <nav class="main-menu mobile-menu">
                <ul>
                    ...
                    <li><a href="{{route('houses.list')}}">Houses</a></li>
                    <li><a href="#">Pages</a>
                        <ul class="drop-menu">
                    ...
                    <li><a href="{{route('houses.create')}}">Upload House</a>
                    </li>
                </ul>
            </nav>
...
<footer class="footer-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 ">
                <div class="small text-white text-center mb-3">
                    &copy;<script>document.write(new Date().getFullYear());</script>
                    Bản quyền thuộc về Công ty TNHH VTM Việt Nam. Mọi hành vi
                    sao chép đều là phạm pháp nếu không có sự cho phép bằng văn bản của chúng tôi
                </div>
            </div>
        </div>
    </div>
